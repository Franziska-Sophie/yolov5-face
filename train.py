...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    logger.info(
        ...
        % (imgsz, imgsz_test, train_loader.num_workers, save_dir, epochs)
    )
    for epoch in range(
        start_epoch, epochs
    ):  # epoch ------------------------------------------------------------------
...
if __name__ == "__main__":
    # CUDA_VISIBLE_DEVICES="0,1,2,3" python3 train.py --data ../cabin-pre-annotations/annotations/yolo_dataset.yaml --cfg models/yolov5m.yaml --weights weights/yolov5m.pt --batch 128 --epochs 3 --img-size 640 --device 0,1,2,3
